        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f6e6d1] p-8 ">
            ...
            <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">Le cours comprend la définitions des objectifs individuels (souplesse, silhouette, renforcement musculaire) et l'élaboration d'un programme sur mesure, réévalué au fils des séances et de vos progressions.
              <br></br>Le cours est suivit d'un massage pour détendre le corps après l'effort.</p>
