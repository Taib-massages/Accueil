  ...
  return (
    <div className="bg-neutral-100 mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-8">
      ...
      <section className="max-w-7xl mx-auto mt-8">
        <h1 className="text-3xl font-bold text-black underline text-center mb-2">
          Taib Massages
        </h1>
        ...
        <div className="max-w-3xl mx-auto">
          <ul className="space-y-4 text-xl text-left">
            ...
            <li><strong className='text-black underline'>Pierres chaudes :</strong> Formation à l'institut Figari Paris France</li>
            <li><strong className='text-black underline'>Pilates :</strong> certificat d'instructeur, Shift U Instituto Portugues de Desporto</li>
            <li><strong className='text-black underline'>Ventouses sèches : </strong>Praticien ventouses traditionnelles chinoises Ecole SHEN en médecine traditionnelle chinoise Paris France</li>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          <Link to="/prestations" className="block">
            <div className="bg-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-semibold mb-4 text-black underline">Prestations et prix</h3>
              <p className="text-gray-600">
                Découvrez mes prestations de Massage, Soins du visage, Réflexologie, Pierres chaudes et ventouses ! 
              </p>
              <span className="inline-block mt-4 text-black font-bold hover:text-gray-700">
          ...
          <Link to="/pilates" className="block">
            <div className="bg-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-semibold mb-4 text-black underline">Cours de pilates</h3>
              <p className="text-gray-600">
          ...
          <Link to="/cadeaux" className="block">
            <div className="bg-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-semibold mb-4 text-black underline">Offrez du bien-être</h3>
              <p className="text-gray-600">
          ...
          <Link to="/contact" className="block">
            <div className="bg-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-semibold mb-4 text-black underline">Contact</h3>
              <p className="text-gray-600">
